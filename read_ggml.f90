...
contains
        ...
        open(UNIT=5, FILE=filename, FORM="UNFORMATTED",&
                ...
                do i = 1,num_layers
                        ...
                        ! f16
                        !call write_tensor(8,temp_gt)
                        w%wqkv(:,(emb_length+kv_head_size+1):(emb_length+2*kv_head_size),i) = temp_gt%f162d
                end do
                ...
                do i = 1,num_layers
                        ...
                        ! f16
                        !call write_tensor(8,temp_gt)
                        w%w13(:,1:ffn_length,i) = temp_gt%f162d
                end do
                ...
                do i = 1,num_layers
                        ...
                        ! f16
                        !call write_tensor(8,temp_gt)
                        w%w13(:,(ffn_length+1):,i) = temp_gt%f162d
                end do
